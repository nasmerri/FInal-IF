...
void PlayerRules()
{
	...
	cout << "\nHello, welcome to my Interactive Fiction.\n";
	cout << "\nWhat is your name?\n";
	cin >> Name;
...
void CharacterSelect()
{
	...
	do
	{
		...
		cout << "\nType 'Human', 'Orc', or 'Halfling'\n";

		cout << Name << "'s" << " Response:";
		...
		if (PlayerAnswer == "Orc")
		{
			cout << "\nYou're " << Name << " the " << MyOrc.Status << " " << *MyOrc.pName << ".\n";
			PlayerHealth = *MyOrc.pHealth;
		}
		else if (PlayerAnswer == "Human")
		{
			cout << "\nYou're a " << Name << " the " << MyHuman.Status << " " << *MyHuman.pName << " " << ".\n";
			PlayerHealth = *MyHuman.pHealth;
		}
		else if (PlayerAnswer == "Halfling")
		{
			cout << "\nYou're a " << Name << " the " << MyHalfling.Status << " " << *MyHalfling.pName << " " << ".\n";
			PlayerHealth = *MyHalfling.pHealth;
		}
		else
		{
	...
	} while (PlayerAnswer != "Orc" && PlayerAnswer != "Human" && PlayerAnswer != "Halfling");
				...
				if (PlayerAnswer == "y")
				{
					...
					else
					{
						...
						case 1:
							...
							cout << "\nIt continues to tear into your flesh and you slip in and out of consciousness.\n";//death
